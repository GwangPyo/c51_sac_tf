...
from stable_baselines.sac.policies import SACPolicy, LOG_STD_MAX, LOG_STD_MIN, gaussian_likelihood, gaussian_entropy, apply_squashing_func
...
class FeedForwardPolicy(SACPolicy):
    ...
    def __init__(self, sess, ob_space, ac_space, n_env=1, n_steps=1, n_batch=None, reuse=False, layers=None,
                 ...
                 layer_norm=False, act_fun=tf.nn.relu, n_spt=256, **kwargs):
        ...
        with tf.variable_scope(scope, reuse=reuse):
            ...
            if create_vf:
                ...
                with tf.variable_scope('vf', reuse=reuse):
                    ...
                    value_fn = tf.layers.dense(vf_h, self.n_spt, name="vf", activation="softmax")
            ...
            if create_qf:
                ...
                with tf.variable_scope('qf1', reuse=reuse):
                    ...
                    qf1 = tf.layers.dense(qf1_h, self.n_spt, name="qf1", activation="softmax")

                with tf.variable_scope('qf2', reuse=reuse):
                    qf2_h = mlp(qf_h, self.layers, self.activ_fn, layer_norm=self.layer_norm)
                    qf2 = tf.layers.dense(qf2_h, self.n_spt, name="qf2", activation="softmax")
    ...
    def behavior_cloning(self, obs, action, ):
        feed_dict = {
